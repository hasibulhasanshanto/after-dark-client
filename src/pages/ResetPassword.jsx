        ...
        <div className="bg-[#0e0e11]/80 backdrop-blur-xl border border-white/10 p-8 rounded-2xl shadow-[0_8px_32px_rgba(0,0,0,0.5)]">
          ...
          <div className="text-center mb-8">
            ...
            <p className="text-xs text-on-surface-variant mt-2 uppercase tracking-widest">
              Establish a new secret phrase to override existing configurations.
            </p>
          </div>
          ...
          {!success ? (
            ...
            <div className="space-y-6 text-center animate-in fade-in duration-300">
              <div className="w-16 h-16 rounded-full bg-primary/10 border border-primary/30 flex items-center justify-center text-primary mx-auto shadow-[0_0_20px_rgba(255,0,214,0.2)]">
              ...
              <div>
                ...
                <p className="text-xs text-on-surface-variant mt-2 leading-relaxed uppercase tracking-wider">
                  Passkey successfully overridden. You can now establish access with the new credentials.
                </p>
              </div>

              <Link
                to="/signin"
                className="inline-block w-full bg-primary text-on-primary font-bold py-3 rounded-xl transition-all uppercase tracking-wider text-xs hover:shadow-[0_0_20px_rgba(255,0,214,0.6)] text-center cursor-pointer"
              >
                Authenticate Now
              </Link>
            </div>
